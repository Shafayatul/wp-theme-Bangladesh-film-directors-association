...
<div class="container">    
    ...
    <br>
      <div class="row">
          ...
          <div class="panel-heading">  <br><h4 >  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;My Profile  &nbsp;  &nbsp;  &nbsp;  &nbsp;<a href="<?php echo site_url('/edit-profile/');?>"><button class="btn btn-primary">Edit Profile</button></a> <a href="http://directorsguildbd.com/webmail"><button class="btn btn-primary">Webmail Login</button></a></h4><br></div>
           <div class="panel-body">
          <div class="col-md-4 col-xs-12 col-sm-6 col-lg-4">
          <?php 
          if(isset($all_meta_for_user['custom_user_profile_pic'][0]) && $all_meta_for_user['custom_user_profile_pic'][0]!=""){
          ?>
            <img  src="<?php echo get_site_url().'/wp-content/uploads/profile_pic/'.$all_meta_for_user['custom_user_profile_pic'][0];?>"   id="profile-image1" class="img-responsive img-thumbnail">
          <?php }else{ ?>  
